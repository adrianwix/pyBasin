...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "pendulum_ode",
        "sources": [
            "/home/adrian/code/thesis/pyBasinWorkspace/experiments/zig/zig_cython/odes/pendulum_ode.pyx"
        ]
    },
    "module_name": "pendulum_ode"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pendulum_ode
#define __PYX_HAVE_API__pendulum_ode
/* Early includes */
#include <math.h>
#ifdef _OPENMP
#include <omp.h>
...
/* Module declarations from "pendulum_ode" */
static void __pyx_f_12pendulum_ode_pendulum_ode(double, double const *, double *, double const *, size_t); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "pendulum_ode"
extern int __pyx_module_is_main_pendulum_ode;
int __pyx_module_is_main_pendulum_ode = 0;

/* Implementation of "pendulum_ode" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_Pendulum_ODE_compiled_to_native[] = "\nPendulum ODE compiled to native C via Cython.\n\nWrite the ODE in Python-like syntax, compile once with Cython,\nand pass the resulting C function pointer to the Zig solver.\nThe hot loop runs entirely in native code \342\200\224 no Python, no GIL.\n\nBuild:\n    cythonize -i pendulum_ode.pyx\n\nThe exported `get_fn_ptr()` returns the raw C function address\nthat the Zig solver can call directly.\n";
/* #### Code section: decls ### */
static PyObject *__pyx_pf_12pendulum_ode_get_fn_ptr(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
...
#define __pyx_kp_u_pendulum_ode_pyx __pyx_string_tab[1]
...
#define __pyx_n_u_get_fn_ptr __pyx_string_tab[6]
...
#define __pyx_n_u_pendulum_ode __pyx_string_tab[13]
#define __pyx_n_u_qualname __pyx_string_tab[14]
#define __pyx_n_u_return __pyx_string_tab[15]
...
#define __pyx_n_u_values __pyx_string_tab[19]
#define __pyx_kp_b_iso88591_A_81A __pyx_string_tab[20]
...
static void __pyx_f_12pendulum_ode_pendulum_ode(CYTHON_UNUSED double __pyx_v_t, double const *__pyx_v_y, double *__pyx_v_dydt, double const *__pyx_v_params, CYTHON_UNUSED size_t __pyx_v_dim) {
  double __pyx_v_theta;
  double __pyx_v_theta_dot;
...
*/
  __pyx_v_alpha = (__pyx_v_params[0]);
 ...
 * 
*/
  __pyx_v_torque = (__pyx_v_params[1]);
 ...
 * 
*/
  (__pyx_v_dydt[0]) = __pyx_v_theta_dot;
 ...
 * 
*/
  (__pyx_v_dydt[1]) = ((((-__pyx_v_alpha) * __pyx_v_theta_dot) + __pyx_v_torque) - (__pyx_v_k * sin(__pyx_v_theta)));
...
/* Python wrapper */
static PyObject *__pyx_pw_12pendulum_ode_1get_fn_ptr(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
PyDoc_STRVAR(__pyx_doc_12pendulum_ode_get_fn_ptr, "Return the raw C function pointer as a Python integer.\n\n    Python passes this to ctypes, which hands it to the Zig solver.\n    From Zig's perspective, it's just a `*const fn(...)` \342\200\224 a normal\n    C function pointer with zero overhead per call.\n    ");
static PyMethodDef __pyx_mdef_12pendulum_ode_1get_fn_ptr = {"get_fn_ptr", (PyCFunction)__pyx_pw_12pendulum_ode_1get_fn_ptr, METH_NOARGS, __pyx_doc_12pendulum_ode_get_fn_ptr};
static PyObject *__pyx_pw_12pendulum_ode_1get_fn_ptr(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_fn_ptr (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_12pendulum_ode_get_fn_ptr(__pyx_self);
...
static PyObject *__pyx_pf_12pendulum_ode_get_fn_ptr(CYTHON_UNUSED PyObject *__pyx_self) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("get_fn_ptr", 0);
...
*/
  ...
  __pyx_t_1 = __Pyx_PyLong_FromSize_t(((size_t)(&__pyx_f_12pendulum_ode_pendulum_ode))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_PyInt_FromNumber(&__pyx_t_1, NULL, 0) < (0)) __PYX_ERR(0, 54, __pyx_L1_error)
...
*/
  ...
  __Pyx_AddTraceback("pendulum_ode.get_fn_ptr", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
static int __pyx_pymod_exec_pendulum_ode(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_pendulum_ode},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "pendulum_ode",
      __pyx_k_Pendulum_ODE_compiled_to_native, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_pendulum_ode(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_pendulum_ode(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_pendulum_ode(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'pendulum_ode' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "pendulum_ode" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_pendulum_ode", 0);
  ...
  if (__pyx_module_is_main_pendulum_ode) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pendulum_ode")) {
      if (unlikely((PyDict_SetItemString(modules, "pendulum_ode", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_return, __pyx_mstate_global->__pyx_n_u_int) < (0)) __PYX_ERR(0, 47, __pyx_L1_error)
  __pyx_t_3 = __Pyx_CyFunction_New(&__pyx_mdef_12pendulum_ode_1get_fn_ptr, 0, __pyx_mstate_global->__pyx_n_u_get_fn_ptr, NULL, __pyx_mstate_global->__pyx_n_u_pendulum_ode, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 47, __pyx_L1_error)
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_get_fn_ptr, __pyx_t_3) < (0)) __PYX_ERR(0, 47, __pyx_L1_error)
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init pendulum_ode", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init pendulum_ode");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{16},{20},{18},{18},{8},{10},{3},{13},{5},{8},{10},{8},{12},{12},{6},{12},{10},{8},{6},{16}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (171 bytes) */
const char* const cstring = "x\332M\216A\n\3020\020E\273q'\256<G\301\235;)\270\226\342\005>1\235J0\231\324d\"\355\r\\\366h\036\305#8R\020g\361\346\363\341\317\374\303@\334\025_\002bG\3650\215@\253h\247\243\263\202\023\215r\246\336\344\211\255\213\265\215)\026qL\331z%\034C\222\261t1\366\006\364\205-p%A\317\030$9\026\270\214_\310\t\205\014\004\2431\235\020\365/}\025\233\240\373\277\010p/\306/~\")I\023Y\017/\216\252NK\025/\200PV>\214/\224_\325vn\336\233j\265~\356\347\335\334|\000YAX\000";
    PyObject *data = __Pyx_DecompressString(cstring, 171, 1);
...
const char* const bytes = "?pendulum_ode.pyx__Pyx_PyDict_NextRefasyncio.coroutinescline_in_traceback__func__get_fn_ptrint_is_coroutineitems__main____module____name__pendulum_ode__qualname__return__set_name__setdefault__test__values\320\000\024\220A\360\016\000\005\014\2108\2201\220A";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_pendulum_ode_pyx, __pyx_mstate->__pyx_n_u_get_fn_ptr, __pyx_mstate->__pyx_kp_b_iso88591_A_81A, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
